-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_sqrt_threshold.vhd
...
ENTITY conv_core_ip_src_sqrt_threshold IS
...
END conv_core_ip_src_sqrt_threshold;


ARCHITECTURE rtl OF conv_core_ip_src_sqrt_threshold IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_Subsystem2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : conv_core_ip_src_Subsystem2
    USE ENTITY work.conv_core_ip_src_Subsystem2(rtl);
...
BEGIN
  ...
  u_Subsystem2 : conv_core_ip_src_Subsystem2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
