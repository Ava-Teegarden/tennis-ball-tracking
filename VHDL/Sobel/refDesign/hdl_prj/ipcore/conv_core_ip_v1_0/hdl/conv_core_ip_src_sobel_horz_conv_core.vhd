-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_sobel_horz_conv_core.vhd
...
ENTITY conv_core_ip_src_sobel_horz_conv_core IS
...
END conv_core_ip_src_sobel_horz_conv_core;


ARCHITECTURE rtl OF conv_core_ip_src_sobel_horz_conv_core IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_Subsystem1_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : conv_core_ip_src_Subsystem1_block3
    USE ENTITY work.conv_core_ip_src_Subsystem1_block3(rtl);
...
BEGIN
  ...
  u_Subsystem1 : conv_core_ip_src_Subsystem1_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
