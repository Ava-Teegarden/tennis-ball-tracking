-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_fifo_sof_out.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi4_stream_video_master/conv_core_ip_fifo_sof_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_core_ip_fifo_sof_out IS
...
END conv_core_ip_fifo_sof_out;


ARCHITECTURE rtl OF conv_core_ip_fifo_sof_out IS

  -- Component Declarations
  COMPONENT conv_core_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : conv_core_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.conv_core_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_conv_core_ip_fifo_sof_out_classic_ram_singlebit : conv_core_ip_SimpleDualPortRAM_singlebit
