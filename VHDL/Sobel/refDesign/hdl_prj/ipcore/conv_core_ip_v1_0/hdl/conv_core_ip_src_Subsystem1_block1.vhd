-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_Subsystem1_block1.vhd
...
ENTITY conv_core_ip_src_Subsystem1_block1 IS
...
END conv_core_ip_src_Subsystem1_block1;


ARCHITECTURE rtl OF conv_core_ip_src_Subsystem1_block1 IS
...
BEGIN
  ...
  Bit_Slice3_out1 <= channel_in_unsigned(23 DOWNTO 16);

  Shift_Arithmetic4_out1 <= SHIFT_RIGHT(Bit_Slice3_out1, 2);

  Bit_Slice2_out1 <= channel_in_unsigned(15 DOWNTO 8);

  Shift_Arithmetic3_out1 <= SHIFT_RIGHT(Bit_Slice2_out1, 1);

  Sum_op_stage1 <= resize(Shift_Arithmetic4_out1 + Shift_Arithmetic3_out1, 9);

  Bit_Slice1_out1 <= channel_in_unsigned(7 DOWNTO 0);

  Shift_Arithmetic5_out1 <= SHIFT_RIGHT(Bit_Slice1_out1, 4);
