-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_axi4_stream_video_slave.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi4_stream_video_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_core_ip_axi4_stream_video_slave IS
...
END conv_core_ip_axi4_stream_video_slave;


ARCHITECTURE rtl OF conv_core_ip_axi4_stream_video_slave IS

  -- Component Declarations
  COMPONENT conv_core_ip_fifo_eol
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT conv_core_ip_fifo_sof
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT conv_core_ip_adapter_in
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT conv_core_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : conv_core_ip_fifo_eol
    USE ENTITY work.conv_core_ip_fifo_eol(rtl);

  FOR ALL : conv_core_ip_fifo_sof
    USE ENTITY work.conv_core_ip_fifo_sof(rtl);

  FOR ALL : conv_core_ip_adapter_in
    USE ENTITY work.conv_core_ip_adapter_in(rtl);

  FOR ALL : conv_core_ip_fifo_data
    USE ENTITY work.conv_core_ip_fifo_data(rtl);
...
BEGIN
  u_conv_core_ip_fifo_eol_inst : conv_core_ip_fifo_eol
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_conv_core_ip_fifo_sof_inst : conv_core_ip_fifo_sof
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_conv_core_ip_conv_core_ip_axi4_stream_video_slave_conv_core_ip_adapter_in : conv_core_ip_adapter_in
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_conv_core_ip_fifo_data_inst : conv_core_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
