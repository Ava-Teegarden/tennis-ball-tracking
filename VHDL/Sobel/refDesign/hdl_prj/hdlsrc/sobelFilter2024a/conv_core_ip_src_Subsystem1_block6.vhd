-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_Subsystem1_block6.vhd
...
ENTITY conv_core_ip_src_Subsystem1_block6 IS
...
END conv_core_ip_src_Subsystem1_block6;


ARCHITECTURE rtl OF conv_core_ip_src_Subsystem1_block6 IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_slicer_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          channel_in                      :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  FOR ALL : conv_core_ip_src_slicer_block3
    USE ENTITY work.conv_core_ip_src_slicer_block3(rtl);
...
BEGIN
  ...
  u_slicer : conv_core_ip_src_slicer_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
