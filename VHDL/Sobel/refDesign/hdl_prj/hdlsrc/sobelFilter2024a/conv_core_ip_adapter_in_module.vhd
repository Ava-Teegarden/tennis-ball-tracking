-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_adapter_in_module.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi4_stream_video_slave/conv_core_ip_adapter_in/conv_core_ip_adapter_in_module
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_core_ip_adapter_in_module IS
...
END conv_core_ip_adapter_in_module;


ARCHITECTURE rtl OF conv_core_ip_adapter_in_module IS
  ...
  SIGNAL cond52                           : std_logic;  -- ufix1
  SIGNAL pixel_counter                    : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL cond50                           : std_logic;  -- ufix1
  SIGNAL cond49                           : std_logic;  -- ufix1
  SIGNAL cond51                           : std_logic;  -- ufix1
  SIGNAL cond47                           : std_logic;  -- ufix1
  SIGNAL cond46                           : std_logic;  -- ufix1
  ...
  SIGNAL cond17                           : std_logic;  -- ufix1
  SIGNAL cond15                           : std_logic;  -- ufix1
  SIGNAL cond18                           : std_logic;  -- ufix1
  SIGNAL cond16                           : std_logic;  -- ufix1
  SIGNAL cond19                           : std_logic;  -- ufix1
  SIGNAL cond20                           : std_logic;  -- ufix1
  SIGNAL valid_reg                        : std_logic;  -- ufix1
  SIGNAL cond11                           : std_logic;  -- ufix1
  SIGNAL cond12                           : std_logic;  -- ufix1
  SIGNAL cond13                           : std_logic;  -- ufix1
  SIGNAL cond14                           : std_logic;  -- ufix1
...
BEGIN
  ...
  cond52 <= '1' WHEN line_counter > numoflines_1 ELSE
      '0';

  
  cond50 <= '1' WHEN pixel_counter >= numofpixels_1 ELSE
      '0';

  
  cond49 <= '1' WHEN pixel_counter < hlength_1 ELSE
      '0';

  cond51 <= cond49 AND cond50;

  
  cond47 <= '1' WHEN pixel_counter < numofpixels_1 ELSE
      '0';

  
  cond46 <= '1' WHEN line_counter <= numoflines_1 ELSE
      '0';
  ...
  cond48 <= tvalid AND (cond47 AND (cond45 AND cond46));

  cond53 <= cond52 OR (cond48 OR cond51);
  ...
  cond0 <= '1' WHEN line_counter < numoflines_1 ELSE
      '0';

  cond1 <= cond0 AND (eol AND tvalid);
  ...
  cond40 <= '1' WHEN pixel_counter = hlength_1 ELSE
      '0';

  condition1 <= cond40 AND first_pixel_en;
  ...
  cond39 <= '1' WHEN pixel_counter = hlength_1 ELSE
      '0';

  
  cond38 <= '1' WHEN line_counter = vlength_1 ELSE
      '0';

  condition0 <= cond38 AND cond39;
  ...
  cond8 <= '1' WHEN line_counter <= numoflines_1 ELSE
      '0';

  cond9 <= tvalid AND (cond7 AND cond8);
  ...
  cond17 <= '1' WHEN pixel_counter = hlength_1 ELSE
      '0';

  
  cond15 <= '1' WHEN vlength_1 /= numoflines_1 ELSE
      '0';

  
  cond18 <= '1' WHEN line_counter = vlength_1 ELSE
      '0';

  
  cond16 <= '1' WHEN hlength_1 /= numofpixels_1 ELSE
      '0';

  cond19 <= cond15 OR cond16;

  cond20 <= cond19 AND (cond17 AND cond18);
  ...
  cond12 <= '1' WHEN pixel_counter <= numofpixels_1 ELSE
      '0';
  ...
  cond14 <= '1' WHEN line_counter <= numoflines_1 ELSE
      '0';

  nonblank <= cond14 AND (cond13 AND (cond11 AND cond12));
  ...
  cond37 <= '1' WHEN line_counter = numoflines_1 ELSE
      '0';

  vend_reg <= cond37 AND (eol AND tvalid);
  ...
  cond28 <= '1' WHEN pixel_counter = hlength_1 ELSE
      '0';
  ...
  cond30 <= '1' WHEN pixel_counter < pixel_counter_1 ELSE
      '0';
  ...
  cond29 <= '1' WHEN line_counter < numoflines_1 ELSE
      '0';

  read_out_cond3 <= cond28 AND cond29;

  
  cond31 <= '1' WHEN line_counter <= numoflines_1 ELSE
      '0';

  read_out_cond4 <= cond30 AND cond31;

  
  cond32 <= '1' WHEN pixel_counter = pixel_counter_1 ELSE
      '0';

  
  cond33 <= '1' WHEN line_counter < numoflines_1 ELSE
      '0';

  
  cond34 <= '1' WHEN line_counter = vlength_1 ELSE
      '0';

  
  cond35 <= '1' WHEN pixel_counter <= hlength_1 ELSE
      '0';
  ...
  read_out_cond5 <= cond32 AND cond33;

  
  cond36 <= '1' WHEN pixel_counter > hlength_2 ELSE
      '0';

  read_out_cond6 <= cond36 AND (cond34 AND cond35);
  ...
  cond4 <= '1' WHEN line_counter < numoflines_1 ELSE
      '0';

  cond3 <= cond4 AND (eol_buf AND tvalid_not_1);
  ...
  read_out_cond8 <= tvalid_not_1 AND (cond32 AND cond37);
