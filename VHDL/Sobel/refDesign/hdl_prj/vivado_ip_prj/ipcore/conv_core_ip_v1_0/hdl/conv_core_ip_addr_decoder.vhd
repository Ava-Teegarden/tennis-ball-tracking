-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_addr_decoder.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi_lite/conv_core_ip_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
USE work.conv_core_ip_pkg.ALL;

ENTITY conv_core_ip_addr_decoder IS
...
END conv_core_ip_addr_decoder;


ARCHITECTURE rtl OF conv_core_ip_addr_decoder IS

  -- Signals
  SIGNAL enb                              : std_logic;
  SIGNAL addr_read_unsigned               : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL address_select_level1            : unsigned(2 DOWNTO 0);  -- ufix3
...
BEGIN
  ...
  address_select_level1 <= addr_read_unsigned(2 DOWNTO 0);
  ...
  decode_sel_axi4_stream_video_slave_image_width_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0002#, 14) ELSE
      '0';
  ...
  decode_sel_axi4_stream_video_slave_image_height_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0003#, 14) ELSE
      '0';
  ...
  decode_sel_axi4_stream_video_slave_hporch_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0004#, 14) ELSE
      '0';
  ...
  decode_sel_axi4_stream_video_slave_vporch_1_1 <= '1' WHEN addr_write_unsigned = to_unsigned(16#0005#, 14) ELSE
      '0';
  ...
  mux0_level1_output : PROCESS (address_select_level1, const_0, data_slice_axi4_stream_video_slave_hporch_1,
       data_slice_axi4_stream_video_slave_image_height_1,
       data_slice_axi4_stream_video_slave_image_width_1,
       data_slice_axi4_stream_video_slave_vporch_1, data_slice_axi_enable_1,
  ...
  BEGIN
    CASE address_select_level1 IS
      ...
      WHEN "010" =>
        mux_out0_level1 <= data_slice_axi4_stream_video_slave_image_width_1;
      WHEN "011" =>
        mux_out0_level1 <= data_slice_axi4_stream_video_slave_image_height_1;
      WHEN "100" =>
        mux_out0_level1 <= data_slice_axi4_stream_video_slave_hporch_1;
      WHEN "101" =>
        mux_out0_level1 <= data_slice_axi4_stream_video_slave_vporch_1;
      WHEN "110" =>
