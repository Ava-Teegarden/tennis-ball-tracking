-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_fifo_data_OUT.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi4_stream_video_master/conv_core_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_core_ip_fifo_data_OUT IS
...
END conv_core_ip_fifo_data_OUT;


ARCHITECTURE rtl OF conv_core_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT conv_core_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : conv_core_ip_SimpleDualPortRAM_generic
    USE ENTITY work.conv_core_ip_SimpleDualPortRAM_generic(rtl);
  ...
  SIGNAL cache_data                       : unsigned(63 DOWNTO 0);  -- ufix64
  SIGNAL data_out_next                    : unsigned(63 DOWNTO 0);  -- ufix64
  SIGNAL Out_tmp                          : unsigned(63 DOWNTO 0);  -- ufix64
  SIGNAL afull_num                        : unsigned(2 DOWNTO 0);  -- ufix3

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_conv_core_ip_fifo_data_OUT_classic_ram_generic : conv_core_ip_SimpleDualPortRAM_generic
