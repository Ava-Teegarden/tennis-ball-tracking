-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_sobel_vert_conv_core.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: conv_core_ip_src_sobel_vert_conv_core
-- Source Path: sobelFilter2024a/conv_core/sobel_vert_conv_core
-- Hierarchy Level: 1
-- Model version: 9.17
-- 
-- -------------------------------------------------------------
...
ENTITY conv_core_ip_src_sobel_vert_conv_core IS
...
END conv_core_ip_src_sobel_vert_conv_core;


ARCHITECTURE rtl OF conv_core_ip_src_sobel_vert_conv_core IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_Subsystem1_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : conv_core_ip_src_Subsystem1_block5
    USE ENTITY work.conv_core_ip_src_Subsystem1_block5(rtl);
...
BEGIN
  ...
  u_Subsystem1 : conv_core_ip_src_Subsystem1_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  c9_Constant_out1(1) <= to_signed(16#0000#, 16);
  c9_Constant_out1(2) <= to_signed(-16#1000#, 16);
  c9_Constant_out1(3) <= to_signed(16#2000#, 16);
  c9_Constant_out1(4) <= to_signed(16#0000#, 16);
  c9_Constant_out1(5) <= to_signed(-16#2000#, 16);
  c9_Constant_out1(6) <= to_signed(16#1000#, 16);
  c9_Constant_out1(7) <= to_signed(16#0000#, 16);
