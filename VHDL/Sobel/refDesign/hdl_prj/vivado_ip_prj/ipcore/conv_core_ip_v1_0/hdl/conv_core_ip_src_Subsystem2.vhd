-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_Subsystem2.vhd
...
ENTITY conv_core_ip_src_Subsystem2 IS
...
END conv_core_ip_src_Subsystem2;


ARCHITECTURE rtl OF conv_core_ip_src_Subsystem2 IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_slicer1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT conv_core_ip_src_slicer_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          channel_in                      :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  FOR ALL : conv_core_ip_src_slicer1
    USE ENTITY work.conv_core_ip_src_slicer1(rtl);

  FOR ALL : conv_core_ip_src_slicer_block4
    USE ENTITY work.conv_core_ip_src_slicer_block4(rtl);
...
BEGIN
  ...
  u_slicer1 : conv_core_ip_src_slicer1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
  ...
  u_slicer : conv_core_ip_src_slicer_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
  ...
  Constant_out1 <= to_unsigned(16#37#, 8);
