-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_axi_lite_module.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi_lite/conv_core_ip_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_core_ip_axi_lite_module IS
...
END conv_core_ip_axi_lite_module;


ARCHITECTURE rtl OF conv_core_ip_axi_lite_module IS
  ...
  SIGNAL addr_read_tmp                    : unsigned(13 DOWNTO 0);  -- ufix14
...
BEGIN
  ...
  BEGIN
    ...
    CASE axi_lite_wstate IS
      WHEN "00000000" =>
        IF axi_lite_rstate = to_unsigned(16#00#, 8) THEN 
          out0 := '1';
        ELSE 
          out0 := '0';
        END IF;
        out1 := '0';
        AXI4_Lite_BVALID <= '0';
        IF awvalid = '1' AND (axi_lite_rstate = to_unsigned(16#00#, 8)) THEN 
    ...
    CASE axi_lite_rstate IS
      WHEN "00000000" =>
        arready := hdlcoder_to_stdlogic(axi_lite_wstate = to_unsigned(16#00#, 8)) AND ( NOT awvalid);
        rvalid_int <= '0';
        IF (arvalid = '1' AND (axi_lite_wstate = to_unsigned(16#00#, 8))) AND ( NOT awvalid) = '1' THEN 
  ...
  addr_write <= std_logic_vector(waddr_sel);
  ...
  addr_read_tmp <= AXI4_Lite_ARADDR_unsigned(15 DOWNTO 2);

  addr_read <= std_logic_vector(addr_read_tmp);
