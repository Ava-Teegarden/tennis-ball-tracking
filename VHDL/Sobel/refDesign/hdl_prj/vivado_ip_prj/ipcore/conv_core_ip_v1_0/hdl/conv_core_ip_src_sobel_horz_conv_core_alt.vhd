-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_sobel_horz_conv_core_alt.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: conv_core_ip_src_sobel_horz_conv_core_alt
-- Source Path: sobelFilter2024a/conv_core/sobel_horz_conv_core_alt
-- Hierarchy Level: 1
-- Model version: 9.17
-- 
-- -------------------------------------------------------------
...
ENTITY conv_core_ip_src_sobel_horz_conv_core_alt IS
...
END conv_core_ip_src_sobel_horz_conv_core_alt;


ARCHITECTURE rtl OF conv_core_ip_src_sobel_horz_conv_core_alt IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_Subsystem1_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : conv_core_ip_src_Subsystem1_block4
    USE ENTITY work.conv_core_ip_src_Subsystem1_block4(rtl);
...
BEGIN
  ...
  u_Subsystem1 : conv_core_ip_src_Subsystem1_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
