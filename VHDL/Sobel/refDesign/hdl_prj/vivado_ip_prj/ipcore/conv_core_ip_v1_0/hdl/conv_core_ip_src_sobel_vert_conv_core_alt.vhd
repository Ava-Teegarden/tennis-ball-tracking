-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_sobel_vert_conv_core_alt.vhd
...
-- Source Path: sobelFilter2024a/conv_core/sobel_vert_conv_core_alt
-- Hierarchy Level: 1
-- Model version: 9.17
-- 
-- -------------------------------------------------------------
...
ENTITY conv_core_ip_src_sobel_vert_conv_core_alt IS
...
END conv_core_ip_src_sobel_vert_conv_core_alt;


ARCHITECTURE rtl OF conv_core_ip_src_sobel_vert_conv_core_alt IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_Subsystem1_block6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : conv_core_ip_src_Subsystem1_block6
    USE ENTITY work.conv_core_ip_src_Subsystem1_block6(rtl);
...
BEGIN
  ...
  u_Subsystem1 : conv_core_ip_src_Subsystem1_block6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
