-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_Subsystem1_block3.vhd
...
-- Source Path: sobelFilter2024a/conv_core/sobel_horz_conv_core/Subsystem1
-- Hierarchy Level: 2
-- Model version: 9.17
-- 
-- -------------------------------------------------------------
...
ENTITY conv_core_ip_src_Subsystem1_block3 IS
...
END conv_core_ip_src_Subsystem1_block3;


ARCHITECTURE rtl OF conv_core_ip_src_Subsystem1_block3 IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_slicer_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          channel_in                      :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  FOR ALL : conv_core_ip_src_slicer_block
    USE ENTITY work.conv_core_ip_src_slicer_block(rtl);
...
BEGIN
  ...
  u_slicer : conv_core_ip_src_slicer_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
