-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_fifo_eol_out.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi4_stream_video_master/conv_core_ip_fifo_eol_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_core_ip_fifo_eol_out IS
...
END conv_core_ip_fifo_eol_out;


ARCHITECTURE rtl OF conv_core_ip_fifo_eol_out IS
...
BEGIN
  ...
  u_conv_core_ip_fifo_eol_out_classic_ram : conv_core_ip_SimpleDualPortRAM_singlebit
