-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_fifo_eol.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi4_stream_video_slave/conv_core_ip_fifo_eol
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_core_ip_fifo_eol IS
...
END conv_core_ip_fifo_eol;


ARCHITECTURE rtl OF conv_core_ip_fifo_eol IS
...
BEGIN
  ...
  u_conv_core_ip_fifo_eol_classic_ram : conv_core_ip_SimpleDualPortRAM_singlebit
