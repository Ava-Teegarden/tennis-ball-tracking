-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_fifo_sof.vhd
...
-- Source Path: conv_core_ip/conv_core_ip_axi4_stream_video_slave/conv_core_ip_fifo_sof
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY conv_core_ip_fifo_sof IS
...
END conv_core_ip_fifo_sof;


ARCHITECTURE rtl OF conv_core_ip_fifo_sof IS
...
BEGIN
  ...
  u_conv_core_ip_fifo_sof_classic_ram : conv_core_ip_SimpleDualPortRAM_singlebit
