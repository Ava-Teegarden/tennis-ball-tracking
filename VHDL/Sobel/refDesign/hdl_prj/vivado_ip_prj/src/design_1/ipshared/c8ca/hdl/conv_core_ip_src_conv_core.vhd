...
ARCHITECTURE rtl OF conv_core_ip_src_conv_core IS
  ...
  COMPONENT conv_core_ip_src_color_correct_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT conv_core_ip_src_just_gray_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Video_in                        :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  COMPONENT conv_core_ip_src_normalize_image
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT conv_core_ip_src_gaussian_conv_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Video_in                        :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  COMPONENT conv_core_ip_src_sobel_horz_conv_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Video_in                        :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  COMPONENT conv_core_ip_src_sobel_horz_conv_core_alt
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Video_in                        :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  COMPONENT conv_core_ip_src_sqrt_threshold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT conv_core_ip_src_sobel_vert_conv_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Video_in                        :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  COMPONENT conv_core_ip_src_sobel_vert_conv_core_alt
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Video_in                        :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  FOR ALL : conv_core_ip_src_color_correct_core
    USE ENTITY work.conv_core_ip_src_color_correct_core(rtl);

  FOR ALL : conv_core_ip_src_just_gray_core
    USE ENTITY work.conv_core_ip_src_just_gray_core(rtl);

  FOR ALL : conv_core_ip_src_normalize_image
    USE ENTITY work.conv_core_ip_src_normalize_image(rtl);

  FOR ALL : conv_core_ip_src_gaussian_conv_core
    USE ENTITY work.conv_core_ip_src_gaussian_conv_core(rtl);

  FOR ALL : conv_core_ip_src_sobel_horz_conv_core
    USE ENTITY work.conv_core_ip_src_sobel_horz_conv_core(rtl);

  FOR ALL : conv_core_ip_src_sobel_horz_conv_core_alt
    USE ENTITY work.conv_core_ip_src_sobel_horz_conv_core_alt(rtl);

  FOR ALL : conv_core_ip_src_sqrt_threshold
    USE ENTITY work.conv_core_ip_src_sqrt_threshold(rtl);

  FOR ALL : conv_core_ip_src_sobel_vert_conv_core
    USE ENTITY work.conv_core_ip_src_sobel_vert_conv_core(rtl);

  FOR ALL : conv_core_ip_src_sobel_vert_conv_core_alt
    USE ENTITY work.conv_core_ip_src_sobel_vert_conv_core_alt(rtl);

  -- Signals
  SIGNAL Video_in_unsigned                : unsigned(63 DOWNTO 0);  -- ufix64
  SIGNAL Bit_Slice_out1                   : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL color_correct_core_out1          : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_color_correct_core : conv_core_ip_src_color_correct_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              Video_in => std_logic_vector(Bit_Slice_out1),  -- uint32
              ctrl_hStart => ctrl_hStart,
              ctrl_hEnd => ctrl_hEnd,
              ctrl_vStart => ctrl_vStart,
              ctrl_vEnd => ctrl_vEnd,
              ctrl_valid => ctrl_valid,
              Video_out => color_correct_core_out1,  -- uint32
  ...
  u_just_gray_core : conv_core_ip_src_just_gray_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              Video_in => color_correct_core_out1,  -- uint32
  ...
  u_normalize_image : conv_core_ip_src_normalize_image
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_gaussian_conv_core : conv_core_ip_src_gaussian_conv_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_sobel_horz_conv_core : conv_core_ip_src_sobel_horz_conv_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_sobel_horz_conv_core_alt : conv_core_ip_src_sobel_horz_conv_core_alt
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              Video_in => gaussian_conv_core_out1,  -- uint8
  ...
  u_sqrt_threshold1 : conv_core_ip_src_sqrt_threshold
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_sobel_vert_conv_core : conv_core_ip_src_sobel_vert_conv_core
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              Video_in => gaussian_conv_core_out1,  -- uint8
  ...
  u_sobel_vert_conv_core_alt : conv_core_ip_src_sobel_vert_conv_core_alt
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
              Video_in => gaussian_conv_core_out1,  -- uint8
  ...
  u_sqrt_threshold2 : conv_core_ip_src_sqrt_threshold
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_sqrt_threshold : conv_core_ip_src_sqrt_threshold
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  Bit_Slice_out1 <= Video_in_unsigned(31 DOWNTO 0);
