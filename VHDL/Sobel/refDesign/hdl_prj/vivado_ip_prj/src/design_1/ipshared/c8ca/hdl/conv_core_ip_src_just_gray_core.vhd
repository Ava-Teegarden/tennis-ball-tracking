-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_just_gray_core.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: conv_core_ip_src_just_gray_core
...
ENTITY conv_core_ip_src_just_gray_core IS
...
END conv_core_ip_src_just_gray_core;


ARCHITECTURE rtl OF conv_core_ip_src_just_gray_core IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_Subsystem1_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : conv_core_ip_src_Subsystem1_block1
    USE ENTITY work.conv_core_ip_src_Subsystem1_block1(rtl);
...
BEGIN
  u_Subsystem1 : conv_core_ip_src_Subsystem1_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
