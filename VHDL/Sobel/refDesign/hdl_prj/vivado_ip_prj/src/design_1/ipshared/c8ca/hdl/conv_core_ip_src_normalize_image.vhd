-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_normalize_image.vhd
...
ENTITY conv_core_ip_src_normalize_image IS
...
END conv_core_ip_src_normalize_image;


ARCHITECTURE rtl OF conv_core_ip_src_normalize_image IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_Subsystem1_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : conv_core_ip_src_Subsystem1_block2
    USE ENTITY work.conv_core_ip_src_Subsystem1_block2(rtl);
...
BEGIN
  u_Subsystem1 : conv_core_ip_src_Subsystem1_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
