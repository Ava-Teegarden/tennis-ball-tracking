-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\sobelFilter2024a\conv_core_ip_src_Subsystem1_block5.vhd
...
-- Source Path: sobelFilter2024a/conv_core/sobel_vert_conv_core/Subsystem1
-- Hierarchy Level: 2
-- Model version: 9.17
-- 
-- -------------------------------------------------------------
...
ENTITY conv_core_ip_src_Subsystem1_block5 IS
...
END conv_core_ip_src_Subsystem1_block5;


ARCHITECTURE rtl OF conv_core_ip_src_Subsystem1_block5 IS

  -- Component Declarations
  COMPONENT conv_core_ip_src_slicer_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          channel_in                      :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  FOR ALL : conv_core_ip_src_slicer_block2
    USE ENTITY work.conv_core_ip_src_slicer_block2(rtl);
...
BEGIN
  ...
  u_slicer : conv_core_ip_src_slicer_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
